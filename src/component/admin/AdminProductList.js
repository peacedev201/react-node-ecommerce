...
class AdminProduct extends Component {
    ...
    render() {
        const totalProduct=this.state.productList.length;
        return (
            <div>
                                    ...
                                    {this.state.currentProduct.length > 0 ?
                                        ...
                                        :
                                            <Row className="products products-loop grid ciyashop-products-shortcode">
                                                <div className="col-sm-12 text-center section-b-space mt-4 mt-md-5 no-found" >
                                                    <img src={require(`../../assets/images/empty-search.jpg`)} className="img-fluid mb-4" />
                                                    <h3>Sorry! Couldn't find the product you were looking For!!!    </h3>
                                                    <p className="mb-0">Please try searching with other words.</p>
                                                </div>
                                            </Row>
                                        }
                                </div>
