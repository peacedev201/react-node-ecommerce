    ...
    return (
        <Row className="row section-pb">
            ...
            <div className="ciyashop_banner ciyashop_banner-style-style-1 ciyashop_banner-effect-none">
                <img className="ciyashop_banner-image img-fluid inline" alt="Banner" src={require(`../assets/images/categories/default/Book1-banner2.png`)}  />
                <div className="ciyashop_banner-content ciyashop_banner-content-1">
                    ...
                    <div className="ciyashop_banner-content-inner-wrapper">
                        ...
                        <div className="ciyashop_banner-text"><h2>Description</h2></div>
                        </div>
            ...
            <div className="ciyashop_banner ciyashop_banner-style-style-1 ciyashop_banner-effect-none">
                <img className="ciyashop_banner-image img-fluid inline img-fluid" alt="Banner" src={require(`../assets/images/categories/default/Book2-banner.png`)} />
            ...
            <div className="ciyashop_banner ciyashop_banner-3 ciyashop_banner-style-style-1 ciyashop_banner-effect-none">
                <img className="ciyashop_banner-image img-fluid inline" alt="Banner" src={require(`../assets/images/categories/default/Book1-banner.png`)} />
